    ...
    <AppShell title="진행 중 경매">
      ...
      >
        <p className="page-desc" style={{ margin: 0 }}>
          요약만 보입니다. 카드를 눌러 입찰·메모·확정 메뉴를 펼치세요.
        </p>
        ...
        <div className="stack">
          {items.map(({ auction: a, bids }) => {
            ...
            return (
              <div
                key={a.id}
                className={`auction-row live-card${open ? " live-card-open" : ""}`}
              >
                <button
                  type="button"
                  className="live-card-summary"
                  onClick={() =>
                ...
                >
                  ...
                  <div className="live-card-body">
                    <div className="live-card-title-row">
                      ...
                      <span className="live-card-toggle" aria-hidden="true">
                        {open ? "접기 ▴" : "펼치기 ▾"}
                      </span>
                    </div>
                    ...
                    {!open && (
                      <p className="live-card-preview">
                        {topBid
                          ? `1위 ${topBid.name} · ${formatBidWithCurrency(topBid)}`
                          : "입찰 없음"}
                      </p>
                    )}
                  </div>
                ...
                {open && (
                  <div className="live-card-detail">
